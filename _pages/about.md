...
Publications
======
* **SynLogic: Synthesizing Verifiable Reasoning Data at Scale for Learning Logical Reasoning and Beyond** (First author), Arxiv, 2025. Junteng Liu, Yuanxiang Fan, Zhuo Jiang, Han Ding, Yongyi Hu, Chi Zhang, Yiqi Shi, Shitong Weng, Aili Chen, Shiqi Chen, Yunan Huang, Mozhi Zhang, Pengyu Zhao, Junjie Yan, Junxian He.
* **On the Perception Bottleneck of VLMs for Chart Understanding** (First author), Arxiv, 2025. Junteng Liu, Weihao Zeng, Xiwen Zhang, Yijun Wang, Zifei Shan, Junxian He.
* **On the Universal Truthfulness Hyperplane Inside LLMs** (First author), EMNLP 2024. Junteng Liu, Shiqi Chen, Yu Cheng, Junxian He.
